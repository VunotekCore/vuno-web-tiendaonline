...
final class CartController
{
    ...
    public function __construct(
        ...
        $this->productModel ??= new ProductModel(\App\Config\Database::getConnection());
    }
    ...
    public function sync(): void
    {
        try {
            ...
            $this->jsonError('Error syncing cart: ' . $e->getMessage(), 500);
        }
    }
    ...
    public function add(): void
    {
        try {
            ...
            if ($this->productModel !== null && $color !== '' && $size !== '') {
                $availableStock = $this->productModel->getVariantStock($productId, $color, $size);
                if ($availableStock !== null && $availableStock < $quantity) {
                    $this->jsonError('Insufficient stock for this variant', 409);
                }
            }
            ...
            $this->jsonError('Error adding to cart: ' . $e->getMessage(), 500);
        }
    }
    ...
    public function remove(): void
    {
        try {
            ...
            $this->jsonError('Error removing from cart: ' . $e->getMessage(), 500);
        }
    }
    ...
    public function clear(): void
    {
        try {
            ...
            $this->jsonError('Error clearing cart: ' . $e->getMessage(), 500);
        }
    }
